...
`BirthForm.tsx` 与 `SubmitAction.tsx` 共同控制“开始排盘”按钮在必填项未完成前不可点击，档案字段显示统一使用“档案名”文案。  
`RecordsPage.tsx` 负责档案管理、单框搜索、详情弹层、编辑和删除流程，`RecordDetailDialog.tsx` 负责档案管理内的只读详情弹层。
